$(document).ready(function () {
  ...
  function weatherFunction(searchTerm) {
    var geourl = "http://api.openweathermap.org/geo/1.0/direct?q=" + searchTerm + "&appid=a80a164d766ebf0c251dc46da10b26ea"
    fetch(geourl).then(function (res) {
      return res.json()
    }).then(function (data) {
      console.log(data)
      var weatherurl = "https://api.openweathermap.org/data/2.5/weather?lat=" + data[0].lat + "&lon=" + data[0].lon + "&appid=a80a164d766ebf0c251dc46da10b26ea&units=imperial"
  ...
  function displayCurrentWeather(data) {
    ...
    humidity.innerText = "Humditiy: " + data.main.humidity
